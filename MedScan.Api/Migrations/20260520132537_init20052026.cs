...
namespace MedScan.Api.Migrations {
    /// <inheritdoc />
    public partial class init20052026 : Migration {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder) {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new {
                    ...
                    MethodOfAdministration = table.Column<string>(type: "text",nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => {
                    ...
                    table.CheckConstraint("CK_HomePharmacyItems_Quantity_Positive","\"Quantity\" > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserMedications_Profiles_ProfileId",
                        column: x => x.ProfileId,
                        principalTable: "Profiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table => {
                    ...
                    table.ForeignKey(
                        name: "FK_DoseLogs_UserMedications_UserMedicationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoseLogs_UserMedicationId",
                table: "DoseLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserMedications_ProfileId",
                table: "UserMedications",
                column: "ProfileId");
        }
